...
import { Filter, MapPin, CheckSquare, Square, Download, MessageSquareText, Layers, ShieldCheck, LogOut, RefreshCw, Check, Search } from 'lucide-react';
    ...
    <header ref={headerRef} className={`navbar app-header ${isMobileFiltersOpen ? 'mobile-filters-open' : ''}`}>
      ...
      <div className="filter-group-sleek" style={{ width: '100%', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
          {activeTab !== 'report5' && <div className="filter-item">
        ...
        <div className="header-actions">
          ...
          <button
            ...
            title={syncStatus?.kind === 'error' ? 'Chưa tải được dữ liệu mới — bấm để thử lại' : 'Tải lại dữ liệu'}
          >
            {syncStatus?.kind === 'loading' ? (
          ...
          >
            <MorphIcon icon={isFullscreen ? Minimize2 : Maximize2} size={15} reducedMotion="user" />
          </button>

          {supportsExport && <button
          ...
          <div className="mobile-only-controls">
            <button
              ...
              style={{ padding: '0.25rem 0.4rem' }}
            >
              <MorphIcon icon={isDarkMode ? Sun : Moon} size={15} reducedMotion="user" />
            </button>
